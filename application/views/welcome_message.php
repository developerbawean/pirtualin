...
<head>
  ...
  <link rel="stylesheet" class="alternate-style" title="green" href="<?php echo base_url(); ?>assets/css/skins/green.css" type="text/css" disabled>
  <link rel="stylesheet" class="alternate-style" title="orange" href="<?php echo base_url(); ?>assets/css/skins/orange.css" type="text/css" disabled>
  <link rel="stylesheet" class="alternate-style" title="yellow" href="<?php echo base_url(); ?>assets/css/skins/yellow.css" type="text/css" disabled>
...
<body>
  ...
  <div class="main-container">
    ...
    <div class="main-content">
      ...
      <section class="home section active" id="home">
        <div class="container">
          <div class="intro">
            <img src="<?php echo base_url(); ?>assets/images/about.jpg" alt="profile" class="shadow-dark">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="portfolio-item padd-15" data-category="web-design">
              <div class="portfolio-item-inner shadow-dark">
                <div class="portfolio-img">
                  <img src="<?php echo base_url(); ?>assets/images/portfolio/1.jpg" alt="Web Design">
                </div>
            ...
            <div class="portfolio-item padd-15" data-category="photography">
              <div class="portfolio-item-inner shadow-dark">
                <div class="portfolio-img">
                  <img src="<?php echo base_url(); ?>assets/images/portfolio/2.jpg" alt="Photography">
                </div>
                <div class="portfolio-info">
                  <h4>Photography</h4>
                  <div class="icon">
            ...
            <div class="portfolio-item padd-15" data-category="wordpress">
              <div class="portfolio-item-inner shadow-dark">
                <div class="portfolio-img">
                  <img src="<?php echo base_url(); ?>assets/images/portfolio/3.jpg" alt="Wordpress">
                </div>
                <div class="portfolio-info">
                  <h4>Wordpress</h4>
                  <div class="icon">
            ...
            <div class="portfolio-item padd-15" data-category="web-design">
              <div class="portfolio-item-inner shadow-dark">
                <div class="portfolio-img">
                  <img src="<?php echo base_url(); ?>assets/images/portfolio/4.jpg" alt="portfolio">
                </div>
                <div class="portfolio-info">
                  <h4>Web Design</h4>
                  <div class="icon">
            ...
            <div class="portfolio-item padd-15" data-category="wordpress">
              <div class="portfolio-item-inner shadow-dark">
                <div class="portfolio-img">
                  <img src="<?php echo base_url(); ?>assets/images/portfolio/5.jpg" alt="Wordpress">
                </div>
                <div class="portfolio-info">
                  <h4>Wordpress</h4>
                  <div class="icon">
            ...
            <div class="portfolio-item padd-15" data-category="photography">
              <div class="portfolio-item-inner shadow-dark">
                <div class="portfolio-img">
                  <img src="<?php echo base_url(); ?>assets/images/portfolio/6.jpg" alt="Wordpress">
                </div>
                <div class="portfolio-info">
                  <h4>Photography</h4>
                  <div class="icon">
          ...
          <div class="row">
            <form action="#" class="contact-form padd-15">
              ...
              <div class="row">
                <div class="form-item col-12 padd-15">
                  <div class="form-group">
                    <textarea class="form-control" name="" placeholder="Your Message..."></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
  ...
  <!-- Plugins -->
  <script src="<?php echo base_url(); ?>assets/js/ityped.min.js"></script>
  <!-- Template js -->
